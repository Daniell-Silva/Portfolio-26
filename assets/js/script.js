...
var swiper = new Swiper(".mySwiper", {
  ...
  const btMenuMobileOpen = document.querySelector('#btMenuMobileOpen');
  const menuMobile = document.querySelector('#menuMobile');
  const modalTransparetMenu = document.querySelector('.modal-transparent-menu-Mobile');
  //const btClosed = document.querySelector('#btClosed');
  btMenuMobileOpen.addEventListener('click', function() {
      if(menuMobile.style.marginLeft === '0') {
          menuMobile.style.marginLeft = '-300px';
      } else {
          menuMobile.style.marginLeft = '0';
      }
      modalTransparetMenu.style.display = 'block';
  });
  
  function btClosed() {
      menuMobile.style.marginLeft = '-300px';
      modalTransparetMenu.style.display = 'none';
  }
